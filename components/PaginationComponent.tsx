...
const PaginationComponent: NextComponentType<NextPageContext, {}, Props> = ({ pagination }: Props) => {
	...
	const getPagesList = () => {
		...
		if (pageCount <= 6) {
			 ...
			 * If we extract 3 from current page and its equal or less than 1 we are close to 1 (no need for "...")
			 * Same applies for last page
			 *
			 * Add -1 as an indicator that we're not in the range of a first or last page
